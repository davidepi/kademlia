...
-(void)test04_Distance_getDistanceExactly1
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 159);
}
...
-(void)test05_Distance_getDistanceExactly2
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 158);
}
...
-(void)test06_Distance_getDistanceExactly3
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 157);
}
...
-(void)test07_Distance_getDistanceExactly4
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 156);
}
...
-(void)test08_Distance_getDistanceExactly5
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 155);
}
...
-(void)test09_Distance_getDistanceExactly6
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 154);
}
...
-(void)test10_Distance_getDistanceExactly7
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 153);
}
...
-(void)test11_Distance_getDistanceExactly8
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 152);
}
...
- (void)test13_Distance_getDistanceSecondByte
{
    ...
    XCTAssertEqual(Distance(a,b).getDistance(), 151);
}
...
{
    Key a("OWvU6xxcBPp9Ml52CJxw");  //0x65 0xC3
    Key b("J5rV89VL9pLBSHecIeyN");  //0x65 0xB6
    Key c("WmadfAYyFWFL5CoY5J42");  //0xCA 0x06
    Key d("QX659NlqHABReLgSWDwZ");  //0xCA 0xDA
